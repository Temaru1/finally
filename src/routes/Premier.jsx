  ...
  return(
    ...
    <Container>
      <Row>
        ...
        <p> It has since grown to offer services to numerous governmental organizations, manufacturing companies, oil and gas giants, construction companies, banks and organizations in the hospitality industry </p>
        </div>
        </Col>
        <Col>
        <div className="nbm">
        ...
        <div><p>To be the leading security management company in the country.</p></div>
        <div><h5>OUR MISSION</h5></div>
        <div className="useless4"></div>
        <div><p>To provide services that are professional and cost-tailored, to exceed the expectations of each and every one of our clients.</p></div>
        </div>
        </Col>
      </Row>
