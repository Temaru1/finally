...
export default function Hse(){
  return (
    ...
    <Row className="z4"><h1>Health, Safety and Environment</h1></Row>
    <Row className="z6">

      <Col>
        <img className="z7" src="https://hardleygrey.com/wp-content/uploads/2022/05/Infraserv-painting.png" alt="photo" />
      </Col>
      <Col>
        <img className="z7" src="https://hardleygrey.com/wp-content/uploads/2022/05/Infraserv-gardening.png" alt="photo" />
      </Col>
      <Col>
        <img className="z7" src="https://hardleygrey.com/wp-content/uploads/2022/05/Infraserv-cleaning.png" alt="photo" />
      </Col>
      <Col>
        <img className="z7" src="https://hardleygrey.com/wp-content/uploads/2022/05/IMG-20211215-WA0017.jpg" alt="photo" />
      </Col>
    ...
    <Row className="z1">
      ...
      Operational Regulations stipulate very strict penalties for any violation of our operational guidelines.</p>
        </div>
      </Row>
      <div className="z5"></div>
      <Row className="z2">
        ...
        Hardley Grey QA/QC executive is highly experienced in quality protocols and is empowered by management to supervise and implement preventive procedures and to approve project completion.</p>
        </div>
